...
if ($error == 0) {
    ...
    if ($row == 0)
        ...
        $sql = "INSERT INTO users (email, password, fullname , contact, usertype, optin, restaurantname, code)
VALUES ('$email', '$password', '$name', $contact, $usertype, $opt, $restaurantname, $code)";
